export default function Desktop() {
  return (
    ...
    <div class="mx-auto grid h-screen bg-black place-items-center mx-auto w-full">
      <div class="mx-auto h-[720px] w-[1000px] bg-black rounded-[60px] border-[16px] border-black relative overflow-hidden ring ring-white shadow-xl">
        <img
